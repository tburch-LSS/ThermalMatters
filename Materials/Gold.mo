...
record Gold
  ...
  parameter SI.LinearTemperatureCoefficient a = 3.4e-3 "1/K; Resistivity T coefficient";
  parameter SI.Conductivity sigma0 = 45.17e6 "S/m; Electrical conductivity";annotation(
