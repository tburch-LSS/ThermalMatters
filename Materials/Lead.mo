...
record Lead
  ...
  parameter SI.LinearTemperatureCoefficient a = 3.9e-3 "1/K; Resistivity T coefficient";
  parameter SI.Conductivity sigma0 = 4.81e6 "S/m; Electrical conductivity";annotation(
