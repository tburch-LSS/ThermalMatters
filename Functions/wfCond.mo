...
function wfCond "Wiedemann-Franz thermal conductivity function (kappa,sigma) = wfCond(T,kappa0,T0)"
...
protected
  ...
  // SI.Temperature Tsing "Singular T with const a (K)";
  // SI.Temperature Tstar "T where a=0 (K)";
